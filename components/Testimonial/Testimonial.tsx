...
const Testimonial = () => {
  ...
  return (
    <section className="embla wow fadeIn" ref={emblaRef}>
      <div
        className={`embla__container ~pt-[40px]/[80px] flex items-center ${poppins.className} wow fadeIn`}
      >
        {testimonialData.map(({ imgName, testimonial, role, user }, index) => (
          ...
          >
            <p className="h-fit min-h-[10rem] bg-[#FDFCFC] ~py-[12px]/[16px] px-[1rem] border-[.25px] flex items-center justify-center border-[#0000000D] italic font-[400] rounded-t-[8px] ~text-[12px]/[14px] text-center tracking-[0.28px] text-black wow fadeIn">
              {testimonial}
            </p>
            <div className="bg-white relative z-[600] h-[4px] w-full wow fadeIn"></div>
            <div className="py-[.75rem] bg-[#FDFCFC] border-[.25px] border-[#0000000D] flex items-center gap-[8px] justify-center rounded-b-[8px] w-full wow fadeIn">
              <img
                src={`/images/${imgName}.png`}
                className="rounded-[50%] ~w-[30px]/[40px] aspect-square wow fadeIn"
                alt="Testimonial Image"
              />
              <div className="wow fadeIn">
                <h6 className="mb-[-4px] ~text-[14px]/[20px] font-[500] tracking-[.8px] text-[#000000D9] wow fadeIn">
                  {user}
                </h6>
                <p className="text-[#00000080] font-[500] ~text-[10px]/[12px] tracking-[.48px] wow fadeIn">
                  {role}
                </p>
              </div>
            </div>
            <p
              ...
              className={`${abeeze.className} text-[20rem] max-h-[10rem] text-[#0000000D] z-[500] right-[-20px] font-[400] absolute bottom-[3rem] wow fadeIn`}
            >
              “
            </p>
          </div>
      ...
      <div className="flex items-center w-fit mx-auto ~pb-[10px]/[20px] gap-[.5rem] wow fadeIn">
      ...
      <div className="w-fit md:flex hidden gap-[1.25rem] mx-auto wow fadeIn">
        <button
          className="embla__prev aspect-square hover:bg-transparent hover:text-[#76063D] border-[#76063D] border transition-[.4s] ~w-[32px]/[46px] text-white flex items-center justify-center react-svg bg-[#76063D] rounded-[50%] wow fadeIn"
          onClick={scrollPrev}
        >
          <SVGClient src="/svg/arr-left.svg" />
        </button>
        <button
          className="embla__next aspect-square hover:bg-transparent hover:text-[#76063D] border-[#76063D] border transition-[.4s] ~w-[32px]/[46px] text-white flex items-center justify-center react-svg bg-[#76063D] rounded-[50%] wow fadeIn"
          onClick={scrollNext}
        >
